...
public class JsAdaptedScriptAPILogger extends ScriptableObject implements Wrapper, IClassInstance {
    ...
    public static void init() {
        JsTypesInit.register(new JsTypesInit.DefJsClass(Logger.class, new JsTypesInit.IBuilderClass() {
            @Override
            public Object call(Object arg) {
                return new JsAdaptedScriptAPILogger((Logger) arg);
            }
        }));
    }
    private final Logger self;

    public JsAdaptedScriptAPILogger(Logger self) {
        this.self = self;
    ...
    public static void inject(ScriptableObject scope) {
        ...
        final ScriptableObject global = new BaseScriptableClass() {
            ...
            public Scriptable construct(Context ctx, Scriptable scope, Object[] args) {
                return new JsAdaptedScriptAPILogger(new com.zhekasmirnov.innercore.api.mod.adaptedscript.AdaptedScriptAPI.Logger());
            }
        ...
        scope.put("AdaptedScriptAPILogger", scope, global);
    }
