...
public class JsWorkbenchShapelessRecipe
    ...
    static {
        Class<?> super_clazz = com.zhekasmirnov.innercore.api.mod.recipes
                                   .workbench.WorkbenchShapelessRecipe.class;
    ...
    public static void init() {
        JsTypesInit.register(new JsTypesInit.DefJsClass(
            WorkbenchShapelessRecipe.class, new JsTypesInit.IBuilderClass() {
                @Override
                public Object call(Object arg) {
                    return new JsWorkbenchShapelessRecipe(
                        (WorkbenchShapelessRecipe) arg);
                }
            }));
    }
    private final WorkbenchShapelessRecipe self;
    public JsWorkbenchShapelessRecipe(WorkbenchShapelessRecipe self) {
        this.self = self;
    ...
    public static void inject(ScriptableObject scope) {
                ...
                if (args.length == 4) {
                    return new JsWorkbenchShapelessRecipe(
                        new com.zhekasmirnov.innercore.api.mod.recipes.workbench
                            .WorkbenchShapelessRecipe(wrapInt(args, 0),
        ...
        scope.put("WorkbenchShapelessRecipe", scope, global);
    }
}