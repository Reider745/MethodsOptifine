...
public class JsPlayer extends ScriptableObject implements Wrapper {
    ...
    public static void inject(ScriptableObject scope) {
        ...
        global.put("addItemInventory", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Player.addItemInventory(wrapInt(args, 0), wrapInt(args, 1),
        ...
        global.put("setOffhandItem", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Player.setOffhandItem(wrapInt(args, 0), wrapInt(args, 1),
                    wrapInt(args, 2),
        ...
        global.put("setArmorSlot", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Player.setArmorSlot(wrapInt(args, 0), wrapInt(args, 1),
        ...
        global.put("setAbility", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Player.setAbility(wrapString(args, 0),
        ...
        global.put("addItemCreativeInv", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Player.addItemCreativeInv(wrapInt(args, 0), wrapInt(args, 1),
                    wrapInt(args, 2),
                    wrapObject(args, 3, java.lang.Object.class));
                return Undefined.instance;
            }
        ...
        global.put("setInventorySlot", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Player.setInventorySlot(wrapInt(args, 0), wrapInt(args, 1),
                    wrapInt(args, 2), wrapInt(args, 3),
                    wrapObject(args, 4, java.lang.Object.class));
                return Undefined.instance;
            }
        ...
        global.put("setCarriedItem", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Player.setCarriedItem(wrapInt(args, 0), wrapInt(args, 1),
                    wrapInt(args, 2),
                    wrapObject(args, 3, java.lang.Object.class));
                return Undefined.instance;
            }
