...
public class JsAdaptedScriptAPIPlayerActor extends ScriptableObject implements Wrapper, IClassInstance {
    ...
    public static void init() {
        JsTypesInit.register(new JsTypesInit.DefJsClass(PlayerActor.class, new JsTypesInit.IBuilderClass() {
            @Override
            public Object call(Object arg) {
                return new JsAdaptedScriptAPIPlayerActor((PlayerActor) arg);
            }
        }));
    }
    private final PlayerActor self;

    public JsAdaptedScriptAPIPlayerActor(PlayerActor self) {
        this.self = self;
