...
public class JsAdaptedScriptAPIRecipes extends ScriptableObject implements Wrapper, IClassInstance {
    ...
    public static void init() {
        JsTypesInit.register(new JsTypesInit.DefJsClass(Recipes.class, new JsTypesInit.IBuilderClass() {
            @Override
            public Object call(Object arg) {
                return new JsAdaptedScriptAPIRecipes((Recipes) arg);
            }
        }));
        JsRecipeRegistryWorkbenchUIHandler.init();
    }
    private final Recipes self;

    public JsAdaptedScriptAPIRecipes(Recipes self) {
        this.self = self;
    ...
    public static void inject(ScriptableObject scope) {
        ...
        final ScriptableObject global = new BaseScriptableClass() {
            ...
            public Scriptable construct(Context ctx, Scriptable scope, Object[] args) {
                return new JsAdaptedScriptAPIRecipes(new com.zhekasmirnov.innercore.api.mod.adaptedscript.AdaptedScriptAPI.Recipes());
            }
        ...
        global.put("addShapeless", global, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                return new JsWorkbenchShapelessRecipe(Recipes.addShapeless(wrapObject(args, 0, org.mozilla.javascript.ScriptableObject.class), wrapObject(args, 1, org.mozilla.javascript.NativeArray.class), wrapObject(args, 2, org.mozilla.javascript.Function.class), wrapString(args, 3)));
            }
        });
        ...
        global.put("addShapelessVanilla", global, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                return new JsWorkbenchShapelessRecipe(Recipes.addShapelessVanilla(wrapObject(args, 0, org.mozilla.javascript.ScriptableObject.class), wrapObject(args, 1, org.mozilla.javascript.NativeArray.class), wrapObject(args, 2, org.mozilla.javascript.Function.class), wrapString(args, 3)));
            }
        });
        ...
        global.put("addShapedGeneric", global, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                return new JsWorkbenchShapedRecipe(Recipes.addShapedGeneric(wrapObject(args, 0, org.mozilla.javascript.ScriptableObject.class), wrapObject(args, 1, org.mozilla.javascript.NativeArray.class), wrapObject(args, 2, org.mozilla.javascript.NativeArray.class), wrapObject(args, 3, org.mozilla.javascript.Function.class), wrapString(args, 4), wrapBoolean(args, 5)));
            }
        });
        global.put("addShaped2", global, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                return new JsWorkbenchShapedRecipe(Recipes.addShaped2(wrapInt(args, 0), wrapInt(args, 1), wrapInt(args, 2), wrapObject(args, 3, org.mozilla.javascript.NativeArray.class), wrapObject(args, 4, org.mozilla.javascript.NativeArray.class), wrapObject(args, 5, org.mozilla.javascript.Function.class), wrapString(args, 6)));
            }
        });
        ...
        global.put("addShapedVanilla", global, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                return new JsWorkbenchShapedRecipe(Recipes.addShapedVanilla(wrapObject(args, 0, org.mozilla.javascript.ScriptableObject.class), wrapObject(args, 1, org.mozilla.javascript.NativeArray.class), wrapObject(args, 2, org.mozilla.javascript.NativeArray.class), wrapObject(args, 3, org.mozilla.javascript.Function.class), wrapString(args, 4)));
            }
        });
        ...
        global.put("addShapelessGeneric", global, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                return new JsWorkbenchShapelessRecipe(Recipes.addShapelessGeneric(wrapObject(args, 0, org.mozilla.javascript.ScriptableObject.class), wrapObject(args, 1, org.mozilla.javascript.NativeArray.class), wrapObject(args, 2, org.mozilla.javascript.Function.class), wrapString(args, 3), wrapBoolean(args, 4)));
            }
        });
        ...
        global.put("getRecipeByUid", global, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                final com.zhekasmirnov.innercore.api.mod.recipes.workbench.WorkbenchRecipe res = Recipes.getRecipeByUid(wrapObject(args, 0, java.lang.Object.class));
        ...
        global.put("getRecipeByField", global, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                final com.zhekasmirnov.innercore.api.mod.recipes.workbench.WorkbenchRecipe res = Recipes.getRecipeByField(wrapObject(args, 0, java.lang.Object.class), wrapString(args, 1));
                return ctx.getWrapFactory().wrap(ctx, scope, res, res.getClass());
            }
        });
        global.put("addShaped", global, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                return new JsWorkbenchShapedRecipe(Recipes.addShaped(wrapObject(args, 0, org.mozilla.javascript.ScriptableObject.class), wrapObject(args, 1, org.mozilla.javascript.NativeArray.class), wrapObject(args, 2, org.mozilla.javascript.NativeArray.class), wrapObject(args, 3, org.mozilla.javascript.Function.class), wrapString(args, 4)));
            }
        });
        global.put("addShapeless2", global, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                return new JsWorkbenchShapelessRecipe(Recipes.addShapeless2(wrapInt(args, 0), wrapInt(args, 1), wrapInt(args, 2), wrapObject(args, 3, org.mozilla.javascript.NativeArray.class), wrapObject(args, 4, org.mozilla.javascript.Function.class), wrapString(args, 5)));
            }
        });
        ...
        JsRecipeRegistryWorkbenchUIHandler.inject(global);
        scope.put("AdaptedScriptAPIRecipes", scope, global);
    }

    public static class JsRecipeRegistryWorkbenchUIHandler extends ScriptableObject implements Wrapper, IClassInstance {
        ...
        public static void init() {
            JsTypesInit.register(new JsTypesInit.DefJsClass(WorkbenchUIHandler.class, new JsTypesInit.IBuilderClass() {
                @Override
                public Object call(Object arg) {
                    return new JsRecipeRegistryWorkbenchUIHandler((WorkbenchUIHandler) arg);
                }
            }));
        }
        private final WorkbenchUIHandler self;

        public JsRecipeRegistryWorkbenchUIHandler(WorkbenchUIHandler self) {
            this.self = self;
            put("getClass", this, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
        ...
        public static void inject(ScriptableObject scope) {
            ...
            final ScriptableObject global = new BaseScriptableClass() {
                @Override
                public Scriptable construct(Context ctx, Scriptable scope, Object[] args) {
                    return new JsRecipeRegistryWorkbenchUIHandler(new com.zhekasmirnov.innercore.api.mod.recipes.RecipeRegistry.WorkbenchUIHandler(wrapObject(args, 0, org.mozilla.javascript.ScriptableObject.class), wrapObject(args, 1, com.zhekasmirnov.innercore.api.mod.ui.container.Container.class), wrapObject(args, 2, com.zhekasmirnov.innercore.api.mod.recipes.workbench.WorkbenchField.class)));
                }
            ...
            scope.put("RecipeRegistryWorkbenchUIHandler", scope, global);
        }
