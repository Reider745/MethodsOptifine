...
public class JsAdaptedScriptAPIItem extends ScriptableObject implements Wrapper, IClassInstance {
    ...
    public static void init() {
        JsTypesInit.register(new JsTypesInit.DefJsClass(Item.class, new JsTypesInit.IBuilderClass() {
            @Override
            public Object call(Object arg) {
                return new JsAdaptedScriptAPIItem((Item) arg);
            }
        }));
    }
    private final Item self;

    public JsAdaptedScriptAPIItem(Item self) {
        this.self = self;
    ...
    public static void inject(ScriptableObject scope) {
        ...
        global.put("createItem", global, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                return new JsNativeItem(Item.createItem(wrapInt(args, 0), wrapString(args, 1), wrapString(args, 2), wrapString(args, 3), wrapInt(args, 4)));
            }
        });
        ...
        global.put("createFoodItem", global, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                return new JsNativeItem(Item.createFoodItem(wrapInt(args, 0), wrapString(args, 1), wrapString(args, 2), wrapString(args, 3), wrapInt(args, 4), wrapInt(args, 5)));
            }
        });
        ...
        global.put("createArmorItem", global, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                return new JsNativeItem(Item.createArmorItem(wrapInt(args, 0), wrapString(args, 1), wrapString(args, 2), wrapString(args, 3), wrapInt(args, 4), wrapString(args, 5), wrapInt(args, 6), wrapInt(args, 7), wrapInt(args, 8), wrapDouble(args, 9)));
            }
        });
        ...
        global.put("createThrowableItem", global, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                return new JsNativeItem(Item.createThrowableItem(wrapInt(args, 0), wrapString(args, 1), wrapString(args, 2), wrapString(args, 3), wrapInt(args, 4)));
            }
        });
        ...
        scope.put("AdaptedScriptAPIItem", scope, global);
    }
