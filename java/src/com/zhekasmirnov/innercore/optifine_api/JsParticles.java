...
public class JsParticles extends ScriptableObject implements Wrapper {
    ...
    static {
        Class<?> super_clazz = com.zhekasmirnov.innercore.api.mod.adaptedscript
                                   .AdaptedScriptAPI.Particles.class;
    ...
    public static void inject(ScriptableObject scope) {
        ...
        global.put("nativeParticleEmitterRelease", global,
        ...
        global.put("nativeParticleSubEmitterSetKeepEmitter", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleSubEmitterSetKeepEmitter(
                        wrapLong(args, 0), wrapBoolean(args, 1));
                    return Undefined.instance;
                }
            });
        global.put("nativeParticleTypeSetAnimators", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleTypeSetAnimators(wrapLong(args, 0),
                        wrapLong(args, 1), wrapLong(args, 2),
                        wrapLong(args, 3));
                    return Undefined.instance;
                }
            });
        global.put("addParticle", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Particles.addParticle(wrapInt(args, 0), wrapDouble(args, 1),
                    wrapDouble(args, 2), wrapDouble(args, 3),
                    wrapDouble(args, 4), wrapDouble(args, 5),
                    wrapDouble(args, 6), wrapInt(args, 7));
                return Undefined.instance;
            }
        });
        global.put("nativeParticleTypeSetCollisionParams", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleTypeSetCollisionParams(
                        wrapLong(args, 0), wrapBoolean(args, 1),
                        wrapBoolean(args, 2), wrapInt(args, 3));
                    return Undefined.instance;
                }
            });
        global.put("nativeParticleTypeSetColorNew", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleTypeSetColorNew(wrapLong(args, 0),
                        ...
                        (float) wrapDouble(args, 8));
                    return Undefined.instance;
                }
            });
        global.put("nativeParticleEmitterMoveTo", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleEmitterMoveTo(wrapLong(args, 0),
                        (float) wrapDouble(args, 1),
                        (float) wrapDouble(args, 2),
                        (float) wrapDouble(args, 3));
                    return Undefined.instance;
        ...
        global.put("nativeParticleTypeSetFriction", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleTypeSetFriction(wrapLong(args, 0),
                        (float) wrapDouble(args, 1),
                        (float) wrapDouble(args, 2));
                    return Undefined.instance;
                }
            });
        global.put("nativeParticleTypeSetLifetime", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleTypeSetLifetime(
                        wrapLong(args, 0), wrapInt(args, 1), wrapInt(args, 2));
                    return Undefined.instance;
                }
            });
        global.put(
            "nativeParticleTypeSetSize", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleTypeSetSize(wrapLong(args, 0),
                        (float) wrapDouble(args, 1),
                        (float) wrapDouble(args, 2));
                    return Undefined.instance;
                }
        ...
        global.put(
            "registerParticleType", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    return Particles.registerParticleType(wrapObject(
                        args, 0, org.mozilla.javascript.Scriptable.class));
                }
            });
        global.put("nativeParticleEmitterGetPosition", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleEmitterGetPosition(
                        wrapLong(args, 0), wrapObject(args, 1, float[].class));
                    return Undefined.instance;
                }
            });
        global.put(
            "nativeParticleTypeGetID", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
        ...
        global.put(
            "nativeParticleEmitterMove", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleEmitterMove(wrapLong(args, 0),
                        (float) wrapDouble(args, 1),
                        (float) wrapDouble(args, 2),
                        (float) wrapDouble(args, 3));
                    return Undefined.instance;
        ...
        global.put("nativeParticleEmitterSetVelocity", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleEmitterSetVelocity(
        ...
        global.put("nativeRegisterNewParticleType", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    return Particles.nativeRegisterNewParticleType(
        ...
        global.put("nativeParticleSubEmitterSetKeepVelocity", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleSubEmitterSetKeepVelocity(
                        wrapLong(args, 0), wrapBoolean(args, 1));
                    return Undefined.instance;
                }
            });
        global.put("nativeParticleTypeSetDefaultVelocity", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleTypeSetDefaultVelocity(
                        wrapLong(args, 0), (float) wrapDouble(args, 1),
                        (float) wrapDouble(args, 2),
                        (float) wrapDouble(args, 3));
                    return Undefined.instance;
        ...
        global.put("nativeParticleTypeSetDefaultAcceleration", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleTypeSetDefaultAcceleration(
                        wrapLong(args, 0), (float) wrapDouble(args, 1),
                        (float) wrapDouble(args, 2),
                        (float) wrapDouble(args, 3));
                    return Undefined.instance;
        ...
        global.put("nativeParticleTypeSetRenderType", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleTypeSetRenderType(
                        wrapLong(args, 0), wrapInt(args, 1));
                    return Undefined.instance;
                }
            });
        global.put("nativeNewParticleSubEmitter", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    return Particles.nativeNewParticleSubEmitter(
                        (float) wrapDouble(args, 0), wrapInt(args, 1),
                        wrapInt(args, 2), wrapInt(args, 3));
                }
            });
        global.put("nativeParticleTypeSetSubEmitters", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleTypeSetSubEmitters(
                        wrapLong(args, 0), wrapLong(args, 1), wrapLong(args, 2),
                        wrapLong(args, 3));
                    return Undefined.instance;
                }
            });
        global.put("nativeParticleTypeSetRebuildDelay", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleTypeSetRebuildDelay(
                        wrapLong(args, 0), wrapInt(args, 1));
                    return Undefined.instance;
                }
            });
        global.put("nativeParticleEmit1", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Particles.nativeParticleEmit1(wrapLong(args, 0),
                    wrapInt(args, 1), wrapInt(args, 2),
                    (float) wrapDouble(args, 3), (float) wrapDouble(args, 4),
                    (float) wrapDouble(args, 5));
                return Undefined.instance;
            }
        });
        global.put("nativeParticleEmitterDetach", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
        ...
        global.put("nativeParticleTypeSetAnimatorsNew", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleTypeSetAnimatorsNew(
                        wrapLong(args, 0), wrapLong(args, 1), wrapLong(args, 2),
                        wrapLong(args, 3), wrapLong(args, 4));
                    return Undefined.instance;
                }
            });
        global.put("nativeParticleEmit3", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Particles.nativeParticleEmit3(wrapLong(args, 0),
                    wrapInt(args, 1), wrapInt(args, 2),
                    (float) wrapDouble(args, 3), (float) wrapDouble(args, 4),
                    (float) wrapDouble(args, 5), (float) wrapDouble(args, 6),
                    (float) wrapDouble(args, 7), (float) wrapDouble(args, 8),
                    (float) wrapDouble(args, 9), (float) wrapDouble(args, 10),
                    (float) wrapDouble(args, 11));
                return Undefined.instance;
            }
        });
        global.put("nativeParticleEmit2", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Particles.nativeParticleEmit2(wrapLong(args, 0),
                    wrapInt(args, 1), wrapInt(args, 2),
                    (float) wrapDouble(args, 3), (float) wrapDouble(args, 4),
                    (float) wrapDouble(args, 5), (float) wrapDouble(args, 6),
                    (float) wrapDouble(args, 7), (float) wrapDouble(args, 8));
        ...
        global.put("getParticleTypeById", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                ...
                return new JsParticleType(
                    Particles.getParticleTypeById(wrapInt(args, 0)));
            }
        });
        global.put("nativeParticleEmitterAttachTo", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleEmitterAttachTo(wrapLong(args, 0),
                        wrapLong(args, 1), (float) wrapDouble(args, 2),
                        (float) wrapDouble(args, 3),
                        (float) wrapDouble(args, 4));
                    return Undefined.instance;
                }
        ...
        global.put(
            "nativeParticleTypeSetColor", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleTypeSetColor(wrapLong(args, 0),
                        (float) wrapDouble(args, 1),
                        (float) wrapDouble(args, 2),
                        (float) wrapDouble(args, 3),
                        (float) wrapDouble(args, 4));
        ...
        global.put(
            "nativeNewParticleEmitter", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    return Particles.nativeNewParticleEmitter(
        ...
        global.put("addFarParticle", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Particles.addFarParticle(wrapInt(args, 0), wrapDouble(args, 1),
                    wrapDouble(args, 2), wrapDouble(args, 3),
                    wrapDouble(args, 4), wrapDouble(args, 5),
                    wrapDouble(args, 6), wrapInt(args, 7));
                return Undefined.instance;
        ...
        global.put("nativeParticleSubEmitterSetRandom", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.nativeParticleSubEmitterSetRandom(
                        wrapLong(args, 0), (float) wrapDouble(args, 1));
                    return Undefined.instance;
                }
            });
        global.put(
            "nativeNewParticleAnimator", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    return Particles.nativeNewParticleAnimator(
                        (float) wrapDouble(args, 0),
                        (float) wrapDouble(args, 1),
                        (float) wrapDouble(args, 2),
                        (float) wrapDouble(args, 3), wrapInt(args, 4));
                }
            });
        global.put(
            "addBreakingItemParticle", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Particles.addBreakingItemParticle(wrapInt(args, 0),
                        wrapInt(args, 1), wrapDouble(args, 2),
                        wrapDouble(args, 3), wrapDouble(args, 4));
                    return Undefined.instance;
                }
            });
    ...
    public static class JsParticleEmitter
        ...
        static {
            Class<?> super_clazz = com.zhekasmirnov.innercore.api.particles
                                       .ParticleRegistry.ParticleEmitter.class;
            while (super_clazz != null) {
                Method[] methods = super_clazz.getMethods();
                for (Field field : super_clazz.getDeclaredFields()) {
                    boolean added = true;
        ...
        public JsParticleEmitter(ParticleEmitter self) {
            ...
            put("move", this, new ScriptableFunctionImpl() {
                ...
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    self.move((float) wrapDouble(args, 0),
                        (float) wrapDouble(args, 1),
                        (float) wrapDouble(args, 2));
                    return Undefined.instance;
                }
            ...
            put("setVelocity", this, new ScriptableFunctionImpl() {
                ...
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    self.setVelocity((float) wrapDouble(args, 0),
                        (float) wrapDouble(args, 1),
                        (float) wrapDouble(args, 2));
                    return Undefined.instance;
                }
            ...
            put("emit", this, new ScriptableFunctionImpl() {
                ...
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    if (args.length == 5) {
                        self.emit(wrapInt(args, 0), wrapInt(args, 1),
                            (float) wrapDouble(args, 2),
                            (float) wrapDouble(args, 3),
                            (float) wrapDouble(args, 4));
                        return Undefined.instance;
            ...
            put("moveTo", this, new ScriptableFunctionImpl() {
                ...
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    self.moveTo((float) wrapDouble(args, 0),
                        (float) wrapDouble(args, 1),
                        (float) wrapDouble(args, 2));
                    return Undefined.instance;
                }
        ...
        public static void inject(ScriptableObject scope) {
            ...
            final ScriptableObject global = new BaseScriptableClass() {
                ...
                public Scriptable construct(
                    Context ctx, Scriptable scope, Object[] args) {
                    return new JsParticleEmitter(
                        new com.zhekasmirnov.innercore.api.particles
                            .ParticleRegistry.ParticleEmitter(
                                (float) wrapDouble(args, 0),
                                (float) wrapDouble(args, 1),
                                (float) wrapDouble(args, 2)));
                }
    ...
    public static class JsParticleSubEmitter
        extends ScriptableObject implements Wrapper {
        private static final ConcurrentHashMap<String, Field> fields =
            new ConcurrentHashMap<>();
        ...
        static {
            Class<?> super_clazz =
                com.zhekasmirnov.innercore.api.particles.ParticleRegistry
                    .ParticleSubEmitter.class;
            while (super_clazz != null) {
                Method[] methods = super_clazz.getMethods();
                for (Field field : super_clazz.getDeclaredFields()) {
                    boolean added = true;
        ...
        public static void inject(ScriptableObject scope) {
            ...
            final ScriptableObject global = new BaseScriptableClass() {
                ...
                public Scriptable construct(
                    Context ctx, Scriptable scope, Object[] args) {
                    if (args.length == 1) {
                        return new JsParticleSubEmitter(
                            new com.zhekasmirnov.innercore.api.particles
                                .ParticleRegistry.ParticleSubEmitter(wrapObject(
                                    args, 0,
                    ...
                    if (args.length == 4) {
                        return new JsParticleSubEmitter(
                            new com.zhekasmirnov.innercore.api.particles
                                .ParticleRegistry.ParticleSubEmitter(
                                    (float) wrapDouble(args, 0),
                                    wrapInt(args, 1), wrapInt(args, 2),
                                    wrapInt(args, 3)));
                    }
    ...
    public static class JsParticleAnimator
        extends ScriptableObject implements Wrapper {
        private static final ConcurrentHashMap<String, Field> fields =
            new ConcurrentHashMap<>();
        ...
        public static void inject(ScriptableObject scope) {
            ...
            final ScriptableObject global = new BaseScriptableClass() {
                ...
                public Scriptable construct(
                    Context ctx, Scriptable scope, Object[] args) {
                    if (args.length == 1) {
                        return new JsParticleAnimator(
                            new com.zhekasmirnov.innercore.api.particles
                                .ParticleRegistry.ParticleAnimator(wrapObject(
                                    args, 0,
                                    org.mozilla.javascript.Scriptable.class)));
                    }
                    if (args.length == 5) {
                        return new JsParticleAnimator(
                            new com.zhekasmirnov.innercore.api.particles
                                .ParticleRegistry.ParticleAnimator(
                                    wrapInt(args, 0),
                                    (float) wrapDouble(args, 1),
                                    (float) wrapDouble(args, 2),
                                    (float) wrapDouble(args, 3),
