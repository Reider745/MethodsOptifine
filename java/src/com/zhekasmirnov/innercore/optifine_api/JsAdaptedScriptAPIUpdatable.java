...
public class JsAdaptedScriptAPIUpdatable extends ScriptableObject implements Wrapper, IClassInstance {
    ...
    public static void init() {
        JsTypesInit.register(new JsTypesInit.DefJsClass(Updatable.class, new JsTypesInit.IBuilderClass() {
            @Override
            public Object call(Object arg) {
                return new JsAdaptedScriptAPIUpdatable((Updatable) arg);
            }
        }));
    }
    private final Updatable self;

    public JsAdaptedScriptAPIUpdatable(Updatable self) {
        this.self = self;
    ...
    public static void inject(ScriptableObject scope) {
        ...
        final ScriptableObject global = new BaseScriptableClass() {
            ...
            public Scriptable construct(Context ctx, Scriptable scope, Object[] args) {
                return new JsAdaptedScriptAPIUpdatable(new com.zhekasmirnov.innercore.api.mod.adaptedscript.AdaptedScriptAPI.Updatable());
            }
        ...
        scope.put("AdaptedScriptAPIUpdatable", scope, global);
    }
