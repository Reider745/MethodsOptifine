...
public class JsAdaptedScriptAPIIDRegistry extends ScriptableObject implements Wrapper, IClassInstance {
    ...
    static {
        Class<?> super_clazz = com.zhekasmirnov.innercore.api.mod.adaptedscript.AdaptedScriptAPI.IDRegistry.class;
    ...
    public static void init() {
        JsTypesInit.register(new JsTypesInit.DefJsClass(IDRegistry.class, new JsTypesInit.IBuilderClass() {
            @Override
            public Object call(Object arg) {
                return new JsAdaptedScriptAPIIDRegistry((IDRegistry) arg);
            }
        }));
    }
    private final IDRegistry self;

    public JsAdaptedScriptAPIIDRegistry(IDRegistry self) {
        this.self = self;
    ...
    public static void inject(ScriptableObject scope) {
        ...
        final ScriptableObject global = new BaseScriptableClass() {
            ...
            public Scriptable construct(Context ctx, Scriptable scope, Object[] args) {
                return new JsAdaptedScriptAPIIDRegistry(new com.zhekasmirnov.innercore.api.mod.adaptedscript.AdaptedScriptAPI.IDRegistry());
            }
        ...
        global.put("injectAPI", global, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                IDRegistry.injectAPI(wrapObject(args, 0, org.mozilla.javascript.ScriptableObject.class));
                return Undefined.instance;
            }
        });
        ...
        global.put("getStringIdAndTypeForItemId", global, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                return IDRegistry.getStringIdAndTypeForItemId(wrapInt(args, 0));
            }
        });
        global.put("getStringIdForItemId", global, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
        ...
        scope.put("AdaptedScriptAPIIDRegistry", scope, global);
    }
