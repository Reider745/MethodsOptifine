...
public class JsItemContainer
    ...
    static {
        Class<?> super_clazz =
            com.zhekasmirnov.apparatus.api.container.ItemContainer.class;
    ...
    public static void init() {
        JsTypesInit.register(new JsTypesInit.DefJsClass(
            ItemContainer.class, new JsTypesInit.IBuilderClass() {
                @Override
                public Object call(Object arg) {
                    return new JsItemContainer((ItemContainer) arg);
                }
            }));
    }
    ...
    public JsItemContainer(ItemContainer self) {
        ...
        put("setBinding", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                if (args.length == 2) {
                    self.setBinding(wrapString(args, 0),
            ...
            public Object call(Context ctx, Scriptable scope,
                ...
                if (args.length == 1) {
                    return new JsContainer(
                        self.asLegacyContainer(wrapBoolean(args, 0)));
                }
                throw new RuntimeException("Not method...");
            }
        });
        put("getFullSlot", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                ...
                return new JsItemContainerSlot(
                    self.getFullSlot(wrapString(args, 0)));
            }
        });
        put("closeFor", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                self.closeFor(wrapObject(args, 0,
        ...
        put("setGlobalDirtySlotListener", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return new JsItemContainer(
                    self.setGlobalDirtySlotListener(wrapObject(args, 0,
                        com.zhekasmirnov.apparatus.api.container.ItemContainer
                            .DirtySlotListener.class)));
            }
        });
        ...
        put("getFromSlot", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return self.getFromSlot(wrapString(args, 0), wrapInt(args, 1),
        ...
        put("getGetTransferPolicy", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                final com.zhekasmirnov.apparatus.api.container.ItemContainer
                    .TransferPolicy res =
                    self.getGetTransferPolicy(wrapString(args, 0));
        ...
        put("setDirtySlotListener", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return new JsItemContainer(
                    self.setDirtySlotListener(wrapString(args, 0),
                        wrapObject(args, 1,
                            com.zhekasmirnov.apparatus.api.container
                                .ItemContainer.DirtySlotListener.class)));
            }
        });
        put("setSlotGetTransferPolicy", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return new JsItemContainer(
                    self.setSlotGetTransferPolicy(wrapString(args, 0),
                        wrapObject(args, 1,
                            com.zhekasmirnov.apparatus.api.container
                                .ItemContainer.TransferPolicy.class)));
            }
        });
        ...
        put("openFor", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                self.openFor(wrapObject(args, 0,
                                 com.zhekasmirnov.apparatus.multiplayer.server
                                     .ConnectedClient.class),
                    wrapString(args, 1));
                return Undefined.instance;
        ...
        put("getAddTransferPolicy", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                ...
                final com.zhekasmirnov.apparatus.api.container.ItemContainer
                    .TransferPolicy res =
                    self.getAddTransferPolicy(wrapString(args, 0));
                return ctx.getWrapFactory().wrap(
                    ctx, scope, res, res.getClass());
            }
        });
        put("addServerEventListener", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                self.addServerEventListener(wrapString(args, 0),
                    wrapObject(args, 1,
                        com.zhekasmirnov.apparatus.api.container.ItemContainer
            ...
            public Object call(Context ctx, Scriptable scope,
                ...
                if (args.length == 1) {
                    final com.zhekasmirnov.innercore.api.mod.ui.container
                        .AbstractSlot res = self.getFieldSlot(wrapInt(args, 0));
                    return ctx.getWrapFactory().wrap(
                        ctx, scope, res, res.getClass());
                }
                if (args.length == 2) {
                    final com.zhekasmirnov.innercore.api.mod.ui.container
                        .AbstractSlot res =
                        self.getFieldSlot(wrapInt(args, 0), wrapInt(args, 1));
                    return ctx.getWrapFactory().wrap(
                        ctx, scope, res, res.getClass());
                }
                throw new RuntimeException("Not method...");
        ...
        put("setClientBinding", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                if (args.length == 2) {
                    self.setClientBinding(wrapString(args, 0),
                        wrapObject(args, 1, java.lang.Object.class));
                    return Undefined.instance;
                }
                if (args.length == 3) {
        ...
        put("dropSlot", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                self.dropSlot(wrapObject(args, 0,
                                  com.zhekasmirnov.apparatus.mcpe
                                      .NativeBlockSource.class),
                    wrapString(args, 1), (float) wrapDouble(args, 2),
        ...
        put("sendSlotToInventoryTransaction", this,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    self.sendSlotToInventoryTransaction(
        ...
        put("setGlobalAddTransferPolicy", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return new JsItemContainer(
                    self.setGlobalAddTransferPolicy(wrapObject(args, 0,
                        com.zhekasmirnov.apparatus.api.container.ItemContainer
        ...
        put("sendSlotToSlotTransaction", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                self.sendSlotToSlotTransaction(
        ...
        put("setBindingValidator", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                self.setBindingValidator(wrapString(args, 0),
                    wrapObject(args, 1,
                        com.zhekasmirnov.apparatus.api.container.ItemContainer
                            .BindingValidator.class));
                return Undefined.instance;
            }
        });
        put("setSlot", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                if (args.length == 2) {
                    self.setSlot(wrapString(args, 0),
                        wrapObject(args, 1,
                            com.zhekasmirnov.apparatus.api.container
                                .ItemContainerSlot.class));
                    return Undefined.instance;
                }
                if (args.length == 4) {
        ...
        put("sendInventoryToSlotTransaction", this,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    self.sendInventoryToSlotTransaction(wrapInt(args, 0),
        ...
        put("runTransaction", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                self.runTransaction(wrapObject(args, 0,
                    com.zhekasmirnov.apparatus.api.container.ItemContainer
                        .Transaction.class));
                return Undefined.instance;
            }
        ...
        put("addServerOpenListener", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                self.addServerOpenListener(wrapObject(args, 0,
                    com.zhekasmirnov.apparatus.api.container.ItemContainer
                        .ServerOnOpenListener.class));
                return Undefined.instance;
            }
        });
        ...
        put("sendEvent", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                if (args.length == 2) {
                    self.sendEvent(wrapString(args, 0),
                        wrapObject(args, 1, java.lang.Object.class));
                    return Undefined.instance;
                }
                if (args.length == 3) {
                    self.sendEvent(wrapObject(args, 0,
                                       com.zhekasmirnov.apparatus.multiplayer
                                           .server.ConnectedClient.class),
                        wrapString(args, 1),
                        wrapObject(args, 2, java.lang.Object.class));
                    return Undefined.instance;
                }
        ...
        put("sendResponseEvent", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                self.sendResponseEvent(wrapString(args, 0),
                    wrapObject(args, 1, java.lang.Object.class));
                return Undefined.instance;
            }
        });
        ...
        put("setGlobalBindingValidator", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                self.setGlobalBindingValidator(wrapObject(args, 0,
                    com.zhekasmirnov.apparatus.api.container.ItemContainer
                        .BindingValidator.class));
                return Undefined.instance;
            }
        ...
        put("getBindingValidator", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                final com.zhekasmirnov.apparatus.api.container.ItemContainer
                    .BindingValidator res =
                    self.getBindingValidator(wrapString(args, 0));
                return ctx.getWrapFactory().wrap(
                    ctx, scope, res, res.getClass());
            }
        });
        ...
        put("setGlobalGetTransferPolicy", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return new JsItemContainer(
                    self.setGlobalGetTransferPolicy(wrapObject(args, 0,
                        com.zhekasmirnov.apparatus.api.container.ItemContainer
                            .TransferPolicy.class)));
            }
        });
        ...
        put("getSlot", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return new JsItemContainerSlot(
                    self.getSlot(wrapString(args, 0)));
            }
        });
        ...
        put("setSlotAddTransferPolicy", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return new JsItemContainer(
                    self.setSlotAddTransferPolicy(wrapString(args, 0),
                        wrapObject(args, 1,
                            com.zhekasmirnov.apparatus.api.container
                                .ItemContainer.TransferPolicy.class)));
            }
        ...
        put("addServerCloseListener", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                self.addServerCloseListener(wrapObject(args, 0,
                    com.zhekasmirnov.apparatus.api.container.ItemContainer
                        .ServerOnCloseListener.class));
                return Undefined.instance;
            }
        });
        put("addToSlot", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return self.addToSlot(wrapString(args, 0), wrapInt(args, 1),
                    wrapInt(args, 2), wrapInt(args, 3),
                    wrapObject(args, 4,
                        com.zhekasmirnov.innercore.api.NativeItemInstanceExtra
                            .class),
    ...
    public static void inject(ScriptableObject scope) {
        ...
        final ScriptableObject global = new BaseScriptableClass() {
            ...
            public Scriptable construct(
                ...
                if (args.length == 1) {
                    return new JsItemContainer(
                        new com.zhekasmirnov.apparatus.api.container
                            .ItemContainer(wrapObject(args, 0,
        ...
        global.put(
            "addClientCloseListener", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    ItemContainer.addClientCloseListener(wrapString(args, 0),
                        wrapObject(args, 1,
                            com.zhekasmirnov.apparatus.api.container
                                .ItemContainer.ClientOnCloseListener.class));
                    return Undefined.instance;
                }
            });
        global.put(
            "registerScreenFactory", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    ItemContainer.registerScreenFactory(wrapString(args, 0),
                        wrapObject(args, 1,
                            com.zhekasmirnov.apparatus.api.container
                                .ItemContainer.UiScreenFactory.class));
                    return Undefined.instance;
                }
            });
        global.put(
            "getClientContainerInstance", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    return new JsItemContainer(
                        ItemContainer.getClientContainerInstance(
                            wrapString(args, 0)));
                }
            });
        global.put(
            "addClientOpenListener", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    ItemContainer.addClientOpenListener(wrapString(args, 0),
                        wrapObject(args, 1,
                            com.zhekasmirnov.apparatus.api.container
                                .ItemContainer.ClientOnOpenListener.class));
                    return Undefined.instance;
                }
            });
        ...
        global.put(
            "addClientEventListener", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    ItemContainer.addClientEventListener(wrapString(args, 0),
                        wrapString(args, 1),
                        wrapObject(args, 2,
                            com.zhekasmirnov.apparatus.api.container
                                .ItemContainer.ClientEventListener.class));
                    return Undefined.instance;
                }
            });
