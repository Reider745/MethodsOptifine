...
public class JsNativeRenderMeshReadOnlyVertexData
    ...
    static {
        Class<?> super_clazz = com.zhekasmirnov.innercore.api.NativeRenderMesh
                                   .ReadOnlyVertexData.class;
    ...
    public static void init() {
        JsTypesInit.register(new JsTypesInit.DefJsClass(
            ReadOnlyVertexData.class, new JsTypesInit.IBuilderClass() {
                @Override
                public Object call(Object arg) {
                    return new JsNativeRenderMeshReadOnlyVertexData(
                        (ReadOnlyVertexData) arg);
                }
            }));
    }
    private final ReadOnlyVertexData self;
    public JsNativeRenderMeshReadOnlyVertexData(ReadOnlyVertexData self) {
        this.self = self;
    ...
    public static void inject(ScriptableObject scope) {
        ...
        scope.put("NativeRenderMeshReadOnlyVertexData", scope, global);
    }
}