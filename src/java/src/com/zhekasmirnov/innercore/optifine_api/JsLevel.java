    ...
    public static void inject(ScriptableObject scope) {
        ...
        final ScriptableObject global = new BaseScriptableClass() {
            ...
            public Scriptable construct(
                ...
                return new JsLevel(new com.zhekasmirnov.innercore.api.mod
                                       .adaptedscript.AdaptedScriptAPI.Level());
            }
        ...
        global.put("setFogColor", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Level.setFogColor(wrapDouble(args, 0), wrapDouble(args, 1),
                    wrapDouble(args, 2));
                return Undefined.instance;
            }
        });
        ...
        global.put("addParticle", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Level.addParticle(wrapInt(args, 0), wrapDouble(args, 1),
        ...
        global.put("dropItem", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return Level.dropItem(wrapDouble(args, 0), wrapDouble(args, 1),
                    wrapDouble(args, 2), wrapInt(args, 3), wrapInt(args, 4),
                    wrapInt(args, 5), wrapInt(args, 6),
                    wrapObject(args, 7, java.lang.Object.class));
            }
        });
        ...
        global.put("explode", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Level.explode(wrapDouble(args, 0), wrapDouble(args, 1),
                    wrapDouble(args, 2), wrapDouble(args, 3),
                    wrapBoolean(args, 4));
                return Undefined.instance;
            }
        ...
        global.put("setSkyColor", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Level.setSkyColor(wrapDouble(args, 0), wrapDouble(args, 1),
                    wrapDouble(args, 2));
                return Undefined.instance;
            }
        });
        ...
        global.put("spawnMob", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return Level.spawnMob(wrapDouble(args, 0), wrapDouble(args, 1),
                    wrapDouble(args, 2), wrapInt(args, 3), wrapString(args, 4));
            }
        });
        ...
        global.put("playSoundEnt", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Level.playSoundEnt(wrapObject(args, 0, java.lang.Object.class),
                    wrapString(args, 1), wrapDouble(args, 2),
                    wrapDouble(args, 3));
                return Undefined.instance;
            }
        });
        ...
        global.put("destroyBlock", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Level.destroyBlock(wrapInt(args, 0), wrapInt(args, 1),
                    wrapInt(args, 2), wrapBoolean(args, 3));
                return Undefined.instance;
            }
        });
        ...
        global.put("setCloudColor", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Level.setCloudColor(wrapDouble(args, 0), wrapDouble(args, 1),
                    wrapDouble(args, 2));
                return Undefined.instance;
            }
        });
        ...
        global.put("spawnExpOrbs", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Level.spawnExpOrbs(wrapDouble(args, 0), wrapDouble(args, 1),
                    wrapDouble(args, 2), wrapInt(args, 3));
                return Undefined.instance;
            }
        });
        ...
        global.put("getTileEntity", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return new JsNativeTileEntity(Level.getTileEntity(
                    wrapInt(args, 0), wrapInt(args, 1), wrapInt(args, 2)));
            }
        });
        global.put("playSound", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Level.playSound(wrapDouble(args, 0), wrapDouble(args, 1),
                    wrapDouble(args, 2), wrapString(args, 3),
                    wrapDouble(args, 4), wrapDouble(args, 5));
                return Undefined.instance;
            }
        });
        ...
        global.put("setTile", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Level.setTile(wrapInt(args, 0), wrapInt(args, 1),
                    wrapInt(args, 2), wrapInt(args, 3), wrapInt(args, 4));
                return Undefined.instance;
            }
        });
        global.put(
            "resetUnderwaterFogColor", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
        ...
        global.put("setSunsetColor", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Level.setSunsetColor(wrapDouble(args, 0), wrapDouble(args, 1),
                    wrapDouble(args, 2));
                return Undefined.instance;
            }
        });
        ...
        global.put("setBlockChangeCallbackEnabled", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Level.setBlockChangeCallbackEnabled(
        ...
        global.put("addFarParticle", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                Level.addFarParticle(wrapInt(args, 0), wrapDouble(args, 1),
                    wrapDouble(args, 2), wrapDouble(args, 3),
                    wrapDouble(args, 4), wrapDouble(args, 5),
                    wrapDouble(args, 6), wrapInt(args, 7));
                return Undefined.instance;
        ...
        global.put(
            "setUnderwaterFogDistance", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Level.setUnderwaterFogDistance(
                        wrapDouble(args, 0), wrapDouble(args, 1));
                    return Undefined.instance;
                }
            });
        global.put(
            "setUnderwaterFogColor", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Level.setUnderwaterFogColor(wrapDouble(args, 0),
                        wrapDouble(args, 1), wrapDouble(args, 2));
                    return Undefined.instance;
                }
            });
        ...
        global.put(
            "addBreakingItemParticle", global, new ScriptableFunctionImpl() {
                ...
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    Level.addBreakingItemParticle(wrapInt(args, 0),
        ...
        global.put("clip", global, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return Level.clip(wrapDouble(args, 0), wrapDouble(args, 1),
                    wrapDouble(args, 2), wrapDouble(args, 3),
                    wrapDouble(args, 4), wrapDouble(args, 5), wrapInt(args, 6));
            }
        });
        global.put(
            "resetUnderwaterFogDistance", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
