...
public class JsBlockBreakResult extends ScriptableObject implements Wrapper, IClassInstance {
    ...
    static {
        Class<?> super_clazz = com.zhekasmirnov.apparatus.adapter.innercore.game.block.BlockBreakResult.class;
    ...
    public static void init() {
        JsTypesInit.register(new JsTypesInit.DefJsClass(BlockBreakResult.class, new JsTypesInit.IBuilderClass() {
            @Override
            public Object call(Object arg) {
                return new JsBlockBreakResult((BlockBreakResult) arg);
            }
        }));
    }
    private final BlockBreakResult self;

    public JsBlockBreakResult(BlockBreakResult self) {
        this.self = self;
        ...
        put("getItems", this, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
        ...
        put("setExperience", this, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                self.setExperience(wrapInt(args, 0));
                return Undefined.instance;
            }
        });
    ...
    public static void inject(ScriptableObject scope) {
        ...
        final ScriptableObject global = new BaseScriptableClass() {
            ...
            public Scriptable construct(Context ctx, Scriptable scope, Object[] args) {
                return new JsBlockBreakResult(new com.zhekasmirnov.apparatus.adapter.innercore.game.block.BlockBreakResult());
            }
        ...
        scope.put("BlockBreakResult", scope, global);
    }
