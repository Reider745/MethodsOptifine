...
public class JsBox extends ScriptableObject implements Wrapper {
    ...
    public static void inject(ScriptableObject scope) {
        ...
        final ScriptableObject global = new BaseScriptableClass() {
            ...
            public Scriptable construct(Context ctx, Scriptable scope, Object[] args) {
                if (args.length == 0) {
                    return new JsBox(new com.zhekasmirnov.innercore.api.mod.ui.GuiBlockModel.Box());
                }
                if (args.length == 1) {
                    return new JsBox(new com.zhekasmirnov.innercore.api.mod.ui.GuiBlockModel.Box(wrapObject(args, 0, com.zhekasmirnov.innercore.api.unlimited.BlockShape.class)));
                }
                if (args.length == 2) {
                    return new JsBox(new com.zhekasmirnov.innercore.api.mod.ui.GuiBlockModel.Box(wrapString(args, 0), wrapInt(args, 1)));
                }
                if (args.length == 6) {
                    return new JsBox(new com.zhekasmirnov.innercore.api.mod.ui.GuiBlockModel.Box((float) wrapDouble(args, 0), (float) wrapDouble(args, 1), (float) wrapDouble(args, 2), (float) wrapDouble(args, 3), (float) wrapDouble(args, 4), (float) wrapDouble(args, 5)));
                }
                throw new RuntimeException("Not method...");
            }
