...
public class JsReadOnlyVertexData extends ScriptableObject implements Wrapper {
    ...
    public JsReadOnlyVertexData(ReadOnlyVertexData self) {
        this.self = self;
    ...
    public static void inject(ScriptableObject scope) {
        ...
        scope.put("ReadOnlyVertexData", scope, global);
    }
}