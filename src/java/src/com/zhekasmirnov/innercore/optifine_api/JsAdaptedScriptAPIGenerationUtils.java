...
public class JsAdaptedScriptAPIGenerationUtils extends ScriptableObject implements Wrapper, IClassInstance {
    ...
    public static void init() {
        JsTypesInit.register(new JsTypesInit.DefJsClass(GenerationUtils.class, new JsTypesInit.IBuilderClass() {
            @Override
            public Object call(Object arg) {
                return new JsAdaptedScriptAPIGenerationUtils((GenerationUtils) arg);
            }
        }));
    }
    private final GenerationUtils self;

    public JsAdaptedScriptAPIGenerationUtils(GenerationUtils self) {
        this.self = self;
    ...
    public static void inject(ScriptableObject scope) {
        ...
        final ScriptableObject global = new BaseScriptableClass() {
            ...
            public Scriptable construct(Context ctx, Scriptable scope, Object[] args) {
                return new JsAdaptedScriptAPIGenerationUtils(new com.zhekasmirnov.innercore.api.mod.adaptedscript.AdaptedScriptAPI.GenerationUtils());
            }
        ...
        scope.put("AdaptedScriptAPIGenerationUtils", scope, global);
    }
