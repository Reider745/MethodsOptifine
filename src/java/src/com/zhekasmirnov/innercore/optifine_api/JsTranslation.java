...
public class JsTranslation extends ScriptableObject implements Wrapper {
    ...
    public JsTranslation(Translation self) {
        this.self = self;
    ...
    public static void inject(ScriptableObject scope) {
        ...
        final ScriptableObject global = new BaseScriptableClass() {
            ...
            public Scriptable construct(Context context, Scriptable scriptable, Object[] args) {
                return new JsTranslation(new com.zhekasmirnov.innercore.api.mod.adaptedscript.AdaptedScriptAPI.Translation());
            }
        ...
        scope.put("Translation", scope, global);
    }
