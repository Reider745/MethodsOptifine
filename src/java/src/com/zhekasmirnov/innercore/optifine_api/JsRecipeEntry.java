...
public class JsRecipeEntry
    ...
    public static void init() {
        JsTypesInit.register(new JsTypesInit.DefJsClass(
            RecipeEntry.class, new JsTypesInit.IBuilderClass() {
                @Override
                public Object call(Object arg) {
                    return new JsRecipeEntry((RecipeEntry) arg);
                }
            }));
    }
    private final RecipeEntry self;
    public JsRecipeEntry(RecipeEntry self) {
        this.self = self;
        put("getMask", this, new ScriptableFunctionImpl() {
            @Override
        ...
        put("getCode", this, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return self.getCode();
        ...
        put("isMatching", this, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                if (args.length == 1) {
                    return self.isMatching(wrapObject(args, 0,
    ...
    public static void inject(ScriptableObject scope) {
                ...
                if (args.length == 2) {
                    return new JsRecipeEntry(
                        new com.zhekasmirnov.innercore.api.mod.recipes.workbench
                            .RecipeEntry(wrapInt(args, 0), wrapInt(args, 1)));
                }
                if (args.length == 1) {
                    return new JsRecipeEntry(
                        new com.zhekasmirnov.innercore.api.mod.recipes.workbench
                            .RecipeEntry(wrapObject(args, 0,
                                com.zhekasmirnov.innercore.api.mod.ui.container
                                    .Slot.class)));
                }
                throw new RuntimeException("Not method...");
        ...
        global.put("getCodeByItem", global, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return RecipeEntry.getCodeByItem(
                    wrapInt(args, 0), wrapInt(args, 1));
            }
        });
        scope.put("RecipeEntry", scope, global);
    }
}