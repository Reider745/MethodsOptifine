...
public class JsGuiRenderMesh extends ScriptableObject implements Wrapper, IClassInstance {
    ...
    static {
        Class<?> super_clazz = com.zhekasmirnov.innercore.api.mod.ui.GuiRenderMesh.class;
    ...
    public static void init() {
        JsTypesInit.register(new JsTypesInit.DefJsClass(GuiRenderMesh.class, new JsTypesInit.IBuilderClass() {
            @Override
            public Object call(Object arg) {
                return new JsGuiRenderMesh((GuiRenderMesh) arg);
            }
        }));
    }
    private final GuiRenderMesh self;

    public JsGuiRenderMesh(GuiRenderMesh self) {
        this.self = self;
        ...
        put("draw", this, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                self.draw(wrapObject(args, 0, javax.microedition.khronos.opengles.GL10.class));
                return Undefined.instance;
            }
        });
        ...
        put("setIndices", this, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                self.setIndices(wrapObject(args, 0, short[].class));
                return Undefined.instance;
            }
        });
        put("loadBitmap", this, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                self.loadBitmap(wrapObject(args, 0, android.graphics.Bitmap.class));
                return Undefined.instance;
            }
        });
        put("setVertices", this, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                self.setVertices(wrapObject(args, 0, float[].class));
                return Undefined.instance;
            }
        });
        ...
        put("setColors", this, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                self.setColors(wrapObject(args, 0, float[].class));
                return Undefined.instance;
            }
        });
        ...
        put("setTextureCoordinates", this, new ScriptableFunctionImpl() {
            @Override
            public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                self.setTextureCoordinates(wrapObject(args, 0, float[].class));
                return Undefined.instance;
            }
        });
    ...
    public static void inject(ScriptableObject scope) {
        ...
        final ScriptableObject global = new BaseScriptableClass() {
            ...
            public Scriptable construct(Context ctx, Scriptable scope, Object[] args) {
                return new JsGuiRenderMesh(new com.zhekasmirnov.innercore.api.mod.ui.GuiRenderMesh());
            }
        ...
        scope.put("GuiRenderMesh", scope, global);
    }
