...
public class JsParticleRegistryParticleType
    ...
    public static void init() {
        JsTypesInit.register(new JsTypesInit.DefJsClass(
            ParticleType.class, new JsTypesInit.IBuilderClass() {
                @Override
                public Object call(Object arg) {
                    return new JsParticleRegistryParticleType(
                        (ParticleType) arg);
                }
            }));
    }
    private final ParticleType self;
    public JsParticleRegistryParticleType(ParticleType self) {
        this.self = self;
    ...
    public static void inject(ScriptableObject scope) {
        ...
        scope.put("ParticleRegistryParticleType", scope, global);
    }
}