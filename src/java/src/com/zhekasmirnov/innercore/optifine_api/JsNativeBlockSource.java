...
public class JsNativeBlockSource
    ...
    static {
        Class<?> super_clazz =
            com.zhekasmirnov.apparatus.mcpe.NativeBlockSource.class;
    ...
    public static void init() {
        JsTypesInit.register(new JsTypesInit.DefJsClass(
            NativeBlockSource.class, new JsTypesInit.IBuilderClass() {
                @Override
                public Object call(Object arg) {
                    return new JsNativeBlockSource((NativeBlockSource) arg);
                }
            }));
    }
    ...
    public JsNativeBlockSource(NativeBlockSource self) {
        ...
        put("listEntitiesInAABB", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                if (args.length == 6) {
                    return self.listEntitiesInAABB((float) wrapDouble(args, 0),
                ...
                if (args.length == 7) {
                    return self.listEntitiesInAABB((float) wrapDouble(args, 0),
                        ...
                        (float) wrapDouble(args, 3),
                        (float) wrapDouble(args, 4),
                        (float) wrapDouble(args, 5), wrapInt(args, 6));
                }
                if (args.length == 8) {
                    return self.listEntitiesInAABB((float) wrapDouble(args, 0),
                        (float) wrapDouble(args, 1),
        ...
        put("setExtraBlock", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                if (args.length == 4) {
                    self.setExtraBlock(wrapInt(args, 0), wrapInt(args, 1),
                        wrapInt(args, 2),
                        wrapObject(args, 3,
                            com.zhekasmirnov.apparatus.adapter.innercore.game
                                .block.BlockState.class));
                    return Undefined.instance;
                }
                if (args.length == 5) {
                    self.setExtraBlock(wrapInt(args, 0), wrapInt(args, 1),
        ...
        put("setBlock", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                if (args.length == 4) {
                    self.setBlock(wrapInt(args, 0), wrapInt(args, 1),
                        wrapInt(args, 2),
                        wrapObject(args, 3,
                            com.zhekasmirnov.apparatus.adapter.innercore.game
                                .block.BlockState.class));
        ...
        put("explode", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                self.explode((float) wrapDouble(args, 0),
                    (float) wrapDouble(args, 1), (float) wrapDouble(args, 2),
                    (float) wrapDouble(args, 3), wrapBoolean(args, 4));
                return Undefined.instance;
            }
        });
        ...
        put("fetchEntitiesInAABB", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                if (args.length == 6) {
                    return self.fetchEntitiesInAABB((float) wrapDouble(args, 0),
                        (float) wrapDouble(args, 1),
                        (float) wrapDouble(args, 2),
                        (float) wrapDouble(args, 3),
                        (float) wrapDouble(args, 4),
        ...
        put("destroyBlock", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                ...
                if (args.length == 4) {
                    self.destroyBlock(wrapInt(args, 0), wrapInt(args, 1),
        ...
        put("getBiomeTemperatureAt", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return self.getBiomeTemperatureAt(
                    wrapInt(args, 0), wrapInt(args, 1), wrapInt(args, 2));
            }
        });
        ...
        put("getBlockEntity", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return new JsNativeTileEntity(self.getBlockEntity(
                    wrapInt(args, 0), wrapInt(args, 1), wrapInt(args, 2)));
            }
        });
        put("breakBlockForResult", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                if (args.length == 3) {
                    return new JsBlockBreakResult(self.breakBlockForResult(
                        wrapInt(args, 0), wrapInt(args, 1), wrapInt(args, 2)));
                }
                if (args.length == 4) {
                    return new JsBlockBreakResult(self.breakBlockForResult(
        ...
        put("spawnEntity", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                if (args.length == 4) {
                    return self.spawnEntity((float) wrapDouble(args, 0),
                        (float) wrapDouble(args, 1),
                ...
                if (args.length == 6) {
                    return self.spawnEntity((float) wrapDouble(args, 0),
                        (float) wrapDouble(args, 1),
                        (float) wrapDouble(args, 2), wrapString(args, 3),
                        wrapString(args, 4), wrapString(args, 5));
                }
                throw new RuntimeException("Not method...");
            }
        });
        put("breakBlock", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                if (args.length == 4) {
                    self.breakBlock(wrapInt(args, 0), wrapInt(args, 1),
                        wrapInt(args, 2), wrapBoolean(args, 3));
                    return Undefined.instance;
                }
                if (args.length == 5) {
        ...
        put("listEntitiesOfTypeInAABB", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                if (args.length == 7) {
                    return self.listEntitiesOfTypeInAABB(
                        (float) wrapDouble(args, 0),
                        (float) wrapDouble(args, 1),
                        (float) wrapDouble(args, 2),
                        (float) wrapDouble(args, 3),
                        (float) wrapDouble(args, 4),
                        (float) wrapDouble(args, 5), wrapString(args, 6));
                }
                if (args.length == 8) {
                    return self.listEntitiesOfTypeInAABB(
                        (float) wrapDouble(args, 0),
        ...
        put("spawnDroppedItem", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                if (args.length == 6) {
                    return self.spawnDroppedItem((float) wrapDouble(args, 0),
                        (float) wrapDouble(args, 1),
                        (float) wrapDouble(args, 2), wrapInt(args, 3),
                        wrapInt(args, 4), wrapInt(args, 5));
                }
                if (args.length == 7) {
                    return self.spawnDroppedItem((float) wrapDouble(args, 0),
                        (float) wrapDouble(args, 1),
        ...
        put("getBiomeDownfallAt", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return self.getBiomeDownfallAt(
                    wrapInt(args, 0), wrapInt(args, 1), wrapInt(args, 2));
            }
        });
        put("getBlock", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return new JsBlockState(self.getBlock(
                    wrapInt(args, 0), wrapInt(args, 1), wrapInt(args, 2)));
            }
        });
        ...
        put("fetchEntitiesOfTypeInAABB", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                if (args.length == 7) {
                    return self.fetchEntitiesOfTypeInAABB(
                        (float) wrapDouble(args, 0),
                        (float) wrapDouble(args, 1),
                        (float) wrapDouble(args, 2),
                        (float) wrapDouble(args, 3),
        ...
        put("getExtraBlock", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return new JsBlockState(self.getExtraBlock(
                    wrapInt(args, 0), wrapInt(args, 1), wrapInt(args, 2)));
            }
        });
        ...
        put("breakBlockForJsResult", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                if (args.length == 3) {
                    return self.breakBlockForJsResult(
                        wrapInt(args, 0), wrapInt(args, 1), wrapInt(args, 2));
                }
                if (args.length == 4) {
                    return self.breakBlockForJsResult(wrapInt(args, 0),
        ...
        put("addToTickingQueue", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                if (args.length == 4) {
                    self.addToTickingQueue(wrapInt(args, 0), wrapInt(args, 1),
        ...
        put("clip", this, new ScriptableFunctionImpl() {
            ...
            public Object call(Context ctx, Scriptable scope,
                Scriptable thisObj, Object[] args) {
                return self.clip((float) wrapDouble(args, 0),
                    (float) wrapDouble(args, 1), (float) wrapDouble(args, 2),
                    (float) wrapDouble(args, 3), (float) wrapDouble(args, 4),
                    (float) wrapDouble(args, 5), wrapInt(args, 6),
                    wrapObject(args, 7, float[].class));
            }
        });
    }
    ...
    private static final ConcurrentHashMap<Integer, JsNativeBlockSource> regions = new ConcurrentHashMap<>();
    ...
    public static void inject(ScriptableObject scope) {
        ...
        final ScriptableObject global = new BaseScriptableClass() {
            ...
            public Scriptable construct(
                ...
                if (args.length == 1) {
                    return new JsNativeBlockSource(
                        new com.zhekasmirnov.apparatus.mcpe.NativeBlockSource(
                            wrapInt(args, 0)));
                }
                if (args.length == 3) {
                    return new JsNativeBlockSource(
        ...
        global.put(
            "getCurrentClientRegion", global, new ScriptableFunctionImpl() {
                @Override
        ...
        global.put(
            "resetDefaultBlockSources", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
        ...
        global.put(
            "getCurrentWorldGenRegion", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
        ...
        global.put(
            "getDefaultForDimension", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope, Scriptable thisObj, Object[] args) {
                    return getDefaultForDimension(wrapInt(args, 0));
                }
            });
        global.put("getFromServerCallbackPointer", global,
            new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    return new JsNativeBlockSource(
                        NativeBlockSource.getFromServerCallbackPointer(
                            wrapLong(args, 0)));
                }
            });
        global.put(
            "getFromCallbackPointer", global, new ScriptableFunctionImpl() {
                @Override
                public Object call(Context ctx, Scriptable scope,
                    Scriptable thisObj, Object[] args) {
                    return new JsNativeBlockSource(
                        NativeBlockSource.getFromCallbackPointer(
                            wrapLong(args, 0)));
                }
            });
